<div class="footer_widgets">
	...
	<?php if( get_option('facebook-url') || get_option('instagram-url') || get_option('twitter-url') || get_option('linkedin-url') ): ?>
	...
	<?php if ( function_exists( dynamic_sidebar('footer') ) ) dynamic_sidebar('footer'); ?>
</div>	