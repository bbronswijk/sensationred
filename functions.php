<?php	
	...
	function add_theme_script() {
			...
			wp_enqueue_style('default_stylesheet', get_template_directory_uri().'/style.css','','3.7.0');
			wp_enqueue_style('nav_stylesheet', get_template_directory_uri().'/css/nav.css','','3.7.0');
